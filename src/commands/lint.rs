...
use project_lint_core::scanners::{
    ...
    magic_numbers::MagicNumbersScanner, node_modules_integrity::NodeModulesIntegrityScanner,
    nx_config::NxConfigScanner, nx_project::NxProjectScanner, pnpm_workspace::PnpmWorkspaceScanner,
